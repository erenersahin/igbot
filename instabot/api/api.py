...
class API(object):
    ...
    # ====== VIDEO METHODS ====== #
    def upload_video(
        self, video, duration_limit=None, caption=None, upload_id=None, thumbnail=None, options={}
    ):
        ...
        @return           Object with state of uploading to
                          Instagram (or False)
        """
        return upload_video(self, video, duration_limit, caption, upload_id, thumbnail, options)
